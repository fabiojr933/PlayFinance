  ...
  async function handleSalvar(e) {
    ...
    try {
      ...
      if (resposta.status == 201 || resposta.status == 200) {
        ...
        toast.info('transferencia cadastrado com sucesso');
      }
    } catch (error) {
  ...
  return (
    <div className="main-content-container p-4 container-fluid">
      ...
      <h2 style={{ textAlign: "center" }}>
        <Badge bg="secondary">Cadastro de transferencia</Badge>
      </h2>
      <Card>
        <div style={{ marginTop: 20, marginBottom: 20 }}>
          <Form className="col-sm-4" onSubmit={handleSalvar}>
            <Form.Group className="mb-2" controlId="formBasicEmail">
              ...
              <Form.Control type="text" placeholder="Digite o nome da transferencia" onChange={(e) => { setNome(e.target.value) }} />
            </Form.Group>
...
export default TransferenciaNew;
